		...
		foreach ( $this->_meta_box['fields'] as $field ) {
			...
			switch ( $field['type'] ) {
				...
				case 'text_medium':
					...
					break;
				case 'fax_number':
					echo '<div class="cmb_text_medium_wrapper input-prepend"><span class="add-on"><i class="icon-print"></i></span><input class="cmb_text_medium" type="text" name="', $field['id'], '" id="', $field['id'], '" value="', '' !== $meta ? $meta : $field['std'], '" /><span class="cmb_metabox_description">', $field['desc'], '</span></div>';
					break;
				case 'text_date':
...
case 'repeatable-text':
                ...
                //echo '<a class="repeatable-add button" href="#">+</a> <ul id="'.$field['id'].'-repeatable" class="custom_repeatable">';  
                $irepeat = 0;  
                if ($meta) {  
                    foreach($meta as $row) {  
                ...
                jQuery( document ).ready( function() {
                    ...
                    jQuery('.cmb-cloneable-text-inputs').sortable({  
                        opacity: 0.6,  
                        revert: true,  
                        cursor: 'move',  
                        handle: '.sort'  
				...
				case 'text_time':
					echo '<div class="input-prepend"><span class="add-on"><i class="icon-time"></i></span><input class="cmb_timepicker text_time" type="text" name="', $field['id'], '" id="', $field['id'], '" value="', '' !== $meta ? $meta : $field['std'], '" /></div><span class="cmb_metabox_description">', $field['desc'], '</span>';
					break;
					
				case 'text_time_open_close':
					echo '<table class="open-close-hours"><tr><td class="open"><input class="cmb_timepicker text_time" type="text" name="', $field['id'], '_open" id="', $field['id'], '_open" value="', '' !== $meta ? $meta : $field['std'], '" /></br><span class="cmb_metabox_description">Open</span></td>';
					echo '<td class="close"><input class="cmb_timepicker text_time" type="text" name="', $field['id'], '_close" id="', $field['id'], '_close" value="', '' !== $meta ? $meta : $field['std'], '" /></br><span class="cmb_metabox_description">Close</span></td></tr></table>';
					break;
